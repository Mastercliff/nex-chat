...
import 'package:nex_chat/app/views/bottom_bar/chats/widgets/chat.widgets.dart';
            ...
            children: [
              FlatButton.icon(
                ...
                label: CircleAvatar(
                  ...
                  backgroundImage: routeArgs.photo.isEmpty
            ...
            Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return MessageChat(MessageModel(
                        message:
                            'Teste Gigante de mensagem, acho que posso aumentar ou diminuir algo',
                        date: DateTime.now()));
                  }),
            ),
            ChatDash()
